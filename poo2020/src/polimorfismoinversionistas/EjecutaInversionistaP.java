        ...
        while(opcion <= 4){
            ...
            switch (opcion){
                case 1:
                    ...
                    CuentaAhorroP Ch = new CuentaAhorroP(numCu,numCli,nombre,capInvert,plazoInv);
                ...
                case 2:
                    ...
                    // Creacion del objeto
                    PagareP Pag = new PagareP(numCu,numCli,nombre,capInvert,plazoInv);
                    Pag.calcularInteres();
                ...
                case 3:
                    ...
                    plazoInv = entrada.nextInt();
                    // Creacion del objeto
                    CuentaMaestraP Cm = new CuentaMaestraP(numCu,numCli,nombre,capInvert,plazoInv);
                    Cm.calcularInteres();
